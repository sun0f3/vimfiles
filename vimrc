...
function ToggleTrailSpace()
  ...
  if !exists("b:toggle_trail_space")
    let b:toggle_trail_space = 'false'
  endif
  if b:toggle_trail_space == 'true'
    match
    let b:toggle_trail_space = 'false'
  else
    match ExtraWhitespace /\s\+$/
    let b:toggle_trail_space = 'true'
  endif
endfunction

command!  ClearTrailSpace call ClearTrailSpace()
function ClearTrailSpace()
  %substitute/\s\+$//g
endfunction

autocmd BufWritePre *.{rb,yml,haml,scss,sass,erb} :%s/\s\+$//e
